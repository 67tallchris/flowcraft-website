...
<head>
    ...
    <style>
        /* --- CSS VARIABLES & RESET --- */
        :root {
            /* Palette: Deep Teal (Focus/Calm), Warm Amber (Energy/Dopamine), Off-White (Easy on eyes) */
            --color-bg: #F9FAFB;
            --color-surface: #FFFFFF;
            --color-primary: #0F4C5C; /* Deep Teal */
            --color-primary-dark: #09303b;
            --color-accent: #E36414; /* Burnt Orange */
            ...
            --font-serif: 'Merriweather', Georgia, serif; /* For quotes/emphasis */
        ...
        <section class="hero">
            <div class="container text-center fade-in">
                ...
                <div id="waitlist" style="scroll-margin-top: 100px;">
                    <form class="input-group" onsubmit="event.preventDefault(); alert('Thanks for joining the FlowCraft waitlist! We will be in touch soon.');">
            ...
            <div class="container">
                <div class="grid grid-2">
                    ...
                    <div class="story-img fade-in">
                        <!-- Placeholder representing movement/flow/unicycle -->
            ...
            <div class="container">
                <div class="grid grid-2">
                    <div class="story-img fade-in" style="order: 2;">
                        <!-- Placeholder representing the Book / Starbucks moment -->
